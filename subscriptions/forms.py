...
class SubscriptionEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        model = Subscription
        fields = ['subscription_name', 'active', 'monthly_price',
                  'subscription_category', 'notes', 'reminder_email',
                  'reminder_date', 'reminder_notes']
        widgets = {
            'subscription_name': forms.TextInput(attrs={'class': 'validate'}),
            'active': forms.Select(attrs={'class': 'browser-default'},
            ...
            'subscription_category': forms.Select(attrs={'class':
                                                         'browser-default'}),
        }
